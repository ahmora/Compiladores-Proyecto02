...
{
       0,    48,    48,    60,    67,    71,    83,    86,    91,    94,
     106,   107,   115,   127,   128,   136,   142,   146,   164,   170,
     173,   178,   183,   188,   193,   198,   203,   204,   205,   206,
     207,   211,   223,   224,   232,   244,   245,   253,   265,   266,
     275,   285,   286,   290,   296,   318,   319,   338,   351,   372,
     373,   384,   395,   398,   411,   418,   425,   426,   431,   449,
     454,   458,   472,   477,   481,   485,   494,   506,   512,   525,
     526,   527,   528,   529,   532,   533,   537,   538,   550,   551,
     554,   555,   558,   559,   560,   561,   562,   563,   564,   565,
     566,   567,   570,   571,   574,   583,   594,   603,   611,   612,
     613,   614,   615,   616,   619,   622,   623,   630,   635,   642,
     647,   654,   657,   664,   668,   671,   674,   681,   688,   695,
     704,   720,   737,   738,   752,   764,   777,   788,   810,   816,
     819,   841,   849,   853,   859,   869,   880,   889,   895,   901,
     907,   917,   943,   954,   986,   991,   996,  1001,  1008,  1019,
    1024,  1038,  1043,  1057,  1058,  1061,  1087,  1090,  1093,  1098,
    1105,  1112,  1118,  1126,  1141,  1147,  1158,  1175,  1184
};
#endif
...
static const char *const yytname[] =
{
  ...
  "return_stmt", "funcdef", "parameters", "varargslist", "args_kleene", YY_NULL
};
#endif
...
#line 296 "pysin.y"
    {
						...
						if ((yyvsp[(2) - (2)].nodo) != NULL)
						{
							BinNode* node = dynamic_cast<BinNode*> ((yyvsp[(2) - (2)].nodo));
							while(node->getLeftChild() != NULL) {
								node = dynamic_cast<BinNode*> (node->getLeftChild());
							}
							node->setFChild((yyvsp[(1) - (2)].nodo));
...
#line 431 "pysin.y"
    {
											...
											if ((yyvsp[(2) - (2)].nodo) != NULL)
											{
												ArgsNode* argsn = dynamic_cast<ArgsNode*> ((yyvsp[(2) - (2)].nodo));
												if (argsn != 0)
												{
													CallNode* calln = asTree->bCallNode();
													calln->addFChild((yyvsp[(1) - (2)].nodo));
													calln->addLChild((yyvsp[(2) - (2)].nodo));
...
#line 458 "pysin.y"
    {
								...
								Node* node = (yyvsp[(2) - (2)].nodo);
								// node->accept(*visitor); cout << endl;
								if ((yyvsp[(1) - (2)].nodo) != NULL)
								{
									Node* trailer_kleene = (yyvsp[(1) - (2)].nodo);
...
#line 704 "pysin.y"
    {
																			...
																			exprn->addFChild((yyvsp[(2) - (8)].nodo));

																			ifn->addFChild(exprn);
																			ifn->addLChild((yyvsp[(4) - (8)].nodo));
																			if ((yyvsp[(5) - (8)].nodo) != NULL)
																			{
...
#line 720 "pysin.y"
    {
																			...
																			Node *ifn = asTree->bIfNode();
																			Node* exprn = asTree->bExprNode();
																			exprn->addFChild((yyvsp[(2) - (5)].nodo));

																			ifn->addFChild(exprn);
																			ifn->addLChild((yyvsp[(4) - (5)].nodo));
																			if ((yyvsp[(5) - (5)].nodo) != NULL)
																			{
...
#line 738 "pysin.y"
    {
															...
															Node *ifn = asTree->bIfNode();
															Node* exprn = asTree->bExprNode();
															exprn->addFChild((yyvsp[(3) - (5)].nodo));
...
#line 752 "pysin.y"
    {
														...
														Node* exprn = asTree->bExprNode();
														exprn->addFChild((yyvsp[(2) - (7)].nodo));
...
#line 764 "pysin.y"
    {
														...
														Node *whilen = asTree->bWhileNode();
														Node* exprn = asTree->bExprNode();
														exprn->addFChild((yyvsp[(2) - (4)].nodo));
...
#line 788 "pysin.y"
    {
																	...
																	cout << "exprlist:" << endl;
																	Node* exprlist = (yyvsp[(2) - (6)].nodo);
																	// exprlist->accept(*visitor); cout << endl;
																	cout << "testlist:" << endl;
																	Node* testlist = (yyvsp[(4) - (6)].nodo);
																	// testlist->accept(*visitor); cout << endl;
																	cout << "suite:" << endl;
																	Node* suite = (yyvsp[(6) - (6)].nodo);
...
#line 1175 "pysin.y"
    {
								...
								Node *identn = asTree->bIdentNode(new string((yyvsp[(3) - (3)].cadena)));
								// identn->accept(*visitor); cout << endl;
								Node *argsn = (yyvsp[(1) - (3)].nodo);
