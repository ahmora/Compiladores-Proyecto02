...
static const yytype_uint16 yyrline[] =
{
     ...
     373,   374,   378,   379,   380,   381,   386,   396,   400,   411,
     412,   413,   414,   415,   418,   419,   423,   424,   436,   437,
     440,   441,   444,   445,   446,   447,   448,   449,   450,   451,
     452,   453,   456,   457,   460,   468,   478,   486,   493,   494,
     495,   496,   497,   498,   499,   500,   501,   506,   510,   517,
     521,   527,   530,   534,   538,   541,   544,   545,   546,   547,
     550,   559,   569,   570,   580,   587,   596,   606,   616,   621,
     624,   645,   652,   653,   656,   665,   675,   683,   689,   694,
     699,   707,   727,   736,   768,   773,   778,   783,   790,   801,
     805,   817,   821,   833,   834,   837,   856,   857,   858,   861,
     864,   867,   873,   881,   892,   896,   904,   913,   919
};
#endif
...
/* Line 1787 of yacc.c  */
#line 381 "pysin.y"
    {string* cadena= new string((yyvsp[(2) - (2)].cadena));
						Node *identn = asTree->bIdentNode(cadena); 
						(yyval.nodo)=identn; cout<<".NAME"<<endl;}
    break;
...
#line 501 "pysin.y"
    {cout << ";;;" << (yyvsp[(1) - (1)].cadena) << ";;;" << endl;
				string* cadena= new string((yyvsp[(1) - (1)].cadena));
				Node *identn = asTree->bIdentNode(cadena);
...
#line 530 "pysin.y"
    {cout << ":::" << (yyvsp[(1) - (1)].cadena) << ":::" << endl;  
							Node *strn = asTree->bStrNode((yyvsp[(1) - (1)].cadena));
							//strn->accept(*visitor);
							}
    break;
...
#line 881 "pysin.y"
    {cout << "def name(_):\n" << endl;
						...
						string* cadena= new string((yyvsp[(2) - (5)].cadena));
						Node *identn = asTree->bIdentNode(cadena);
...
/* Line 1787 of yacc.c  */
#line 904 "pysin.y"
    {string* cadena= new string((yyvsp[(1) - (2)].cadena));
				Node *identn = asTree->bIdentNode(cadena);
				if ((yyvsp[(2) - (2)].nodo) != NULL){
					Node *argsn = (yyvsp[(2) - (2)].nodo);
...
/* Line 1787 of yacc.c  */
#line 913 "pysin.y"
    {string* cadena= new string((yyvsp[(3) - (3)].cadena));
				Node *identn = asTree->bIdentNode(cadena);
				Node *argsn = (yyvsp[(1) - (3)].nodo);
